      ...
      <div className={`sidebar ${classes.sidebarActive}`}>
        <ul className='sidebar__nav'>
          <li className='sidebar__nav-item'>
            <a href='index.html' className='sidebar__nav-link sidebar__nav-link--active'>
          ...
          <li className='sidebar__nav-item'>
            <a href='artists.html' className='sidebar__nav-link'>
              <svg xmlns='http://www.w3.org/2000/svg' width='20' height='auto' viewBox='0 0 24 24'>
          ...
          <li className='sidebar__nav-item'>
            <a href='releases.html' className='sidebar__nav-link'>
              <svg xmlns='http://www.w3.org/2000/svg' width='20' height='auto' viewBox='0 0 24 24'>
          ...
          <li className='sidebar__nav-item'>
            <a href='events.html' className='sidebar__nav-link'>
              <svg xmlns='http://www.w3.org/2000/svg' width='20' height='auto' viewBox='0 0 24 24'>
